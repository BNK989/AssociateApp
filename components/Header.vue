<template>
    <header>
        <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800 shadow">
            <div class="relative flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                <NuxtLink to="/" class="flex items-center">
                    <img src="https://flowbite.com/docs/images/logo.svg" class="mr-3 h-6 sm:h-9" alt="Associate Logo" />
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Associate</span>
                </NuxtLink>
                ...
                <div class="hidden absolute md:static md:bg-opacity-0 z-10 bg-blue-950 top-12 justify-between items-center w-dvw -left-4 lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col md:items-center mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <div class="flex items-center justify-evenly bg-blue-200 bg-opacity-20 my-2 md:bg-opacity-0 md:my-0 ">
                        <NuxtLink
                            to="/login"
