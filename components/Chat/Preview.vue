<template>
    <li>
        <NuxtLink :to="localPath(`/game/${game.id}`)">
            <div
                class="grid grid-cols-[minmax(min-content,1fr)_min-content] gap-1 md:min-w-48 min-h-36 max-h-fit rounded bg-accent-3/80 p-2 cursor-pointer hover:bg-accent-3/50 duration-300">
