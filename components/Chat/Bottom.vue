    ...
    <section class="border border-white min-h-8">
        <form @submit.prevent="onHandleSubmit">
            <div class="relative">
                ...
                <button
                    type="submit"
                    class="text-white min-w-32 absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2">
                    {{btnTxt}}
                </button>
            </div>
        </form>
