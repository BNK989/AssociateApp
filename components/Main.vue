<template>
    ...
    <div
        class="main flex-grow overflow-hidden backdrop-blur-lg backdrop-saturate-150 md:border rounded md:border-accent-3/25 flex flex-col md:h-[80%] md:w-[60%] md:m-auto">
        <ChatTop
            :gameMode="gameMode"
