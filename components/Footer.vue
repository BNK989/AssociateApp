<template>        
    <footer class=" w-full p-1 md:p-8 lg:p-2">
      <div class="mx-auto max-w-screen-xl text-center">
          ...
          <!-- <p class="my-4 text-gray-500 ">Open-source library of over 400+ web components and interactive elements built for better web.</p> -->
          <!-- <ul class="my-4 flex flex-wrap justify-center items-center mb-6 text-gray-900">
              <li>
